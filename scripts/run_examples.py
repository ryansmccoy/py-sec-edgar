...
class ExampleRunner:
    ...
    def run_example(self, example_key: str, category: str | None = None) -> bool:
        ...
        # Build full command
        cmd = self.base_cmd + ["--data-dir", self.data_dir] + example["cmd"]
...
def main():
    ...
    group.add_argument("--run", type=str, help="Run a specific example by key")

    group.add_argument(
        "--run-category", type=str, help="Run all examples in a specific category"
    )
    ...
    parser.add_argument(
        "--category", type=str, help="Specify category when running a specific example"
    )
