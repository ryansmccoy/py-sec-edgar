...
# -*- coding: utf-8 -*-
#
# py_sec_edgar_data documentation build configuration file, created by
...
version = py_sec_edgar_data.__version__
# The full version, including alpha/beta/rc tags.
release = py_sec_edgar_data.__version__
...
latex_documents = [
    (master_doc, 'py_sec_edgar_data.tex',
